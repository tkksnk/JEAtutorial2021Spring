...
%kap = 0.06788;
% eval(sprintf('load wsmat_invlam%6.5fph%1.5fpl%1.2fkap%1.5fN%d.mat vmat0 mmat0 nmat0 xmat0 pmat0 rmat0 zmat0 idmat Gs Ps knotsm knotsn ns nm nn rstar',invlam,ph,pl,kap,N));
% vmats = vmat0;
% mmats = mmat0;
% nmats = nmat0;
% xmats = xmat0;
...
% rmats = rmat0;
% zmats = zmat0;
eval(sprintf('load wcmat_invlam%6.5fph%1.5fpl%1.2fkap%1.5f.mat vmat0 mmat0 nmat0 xmat0 pmat0 rmat0 Gs Ps knotsm knotsn ns nm nn rstar',invlam,ph,pl,kap));
vmatc = vmat0;
mmatc = mmat0;
nmatc = nmat0;
xmatc = xmat0;
pmatc = pmat0;
rmatc = rmat0;
%eval(sprintf('save wdmat_invlam%6.5fph%1.5fpl%1.2fN%d.mat vvec0 xvec0 pvec0 rvec0 Gs Ps ns rstar',invlam,ph,pl));
eval(sprintf('load wdmat_invlam%6.5fph%1.5fpl%1.2fkap%1.5f.mat vvec0 xvec0 pvec0 rvec0 Gs Ps ns rstar',invlam,ph,pl,kap));
vvecd = vvec0;
xvecd = xvec0;
pvecd = pvec0;
rvecd = rvec0;
...
save comm.mat xcvec xdvec rcvec rdvec pcvec pdvec;
